 ...
 *
 * @method PlayAction setAudience(\Bordeux\SchemaOrg\Thing\Intangible\Audience $audience )The intended audience of the item, i.e. the group for whom the item was created.
 *
 *
 * -------------------------------- Event ---------------------------------------------
 *
 ...
 *
 * @method PlayAction setEvent(\Bordeux\SchemaOrg\Thing\Event $event )Upcoming or past event associated with this place or organization.
 *
 *
 */
