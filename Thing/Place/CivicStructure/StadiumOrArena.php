 ...
 *
 * @method StadiumOrArena setBrand(\Bordeux\SchemaOrg\Thing\Organization $brand ) setBrand(\Bordeux\SchemaOrg\Thing\Intangible\Brand $brand )The brand(s) associated with a product or service, or the brand(s) maintained by an organization or business person.
 *
 *
 * -------------------------------- ContactPoint ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setContactPoint(\Bordeux\SchemaOrg\Thing\Intangible\StructuredValue\ContactPoint $contactPoint )A contact point for a person or organization.
 *
 *
 * -------------------------------- ContactPoints ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setContactPoints(\Bordeux\SchemaOrg\Thing\Intangible\StructuredValue\ContactPoint $contactPoints )A contact point for a person or organization (legacy spelling; see singular form, contactPoint).
 *
 *
 * -------------------------------- Department ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setDepartment(\Bordeux\SchemaOrg\Thing\Organization $department )A relationship between an organization and a department of that organization, also described as an organization (allowing different urls, logos, opening hours). For example: a store with a pharmacy, or a bakery with a cafe.
 *
 *
 * -------------------------------- Duns ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setDuns(string $duns )The Dun & Bradstreet DUNS number for identifying an organization or business person.
 *
 *
 * -------------------------------- Email ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setEmail(string $email )Email address.
 *
 *
 * -------------------------------- Employee ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setEmployee(\Bordeux\SchemaOrg\Thing\Person $employee )Someone working for this organization.
 *
 *
 * -------------------------------- Employees ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setEmployees(\Bordeux\SchemaOrg\Thing\Person $employees )People working for this organization. (legacy spelling; see singular form, employee)
 *
 *
 * -------------------------------- Founder ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setFounder(\Bordeux\SchemaOrg\Thing\Person $founder )A person who founded this organization.
 *
 *
 * -------------------------------- Founders ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setFounders(\Bordeux\SchemaOrg\Thing\Person $founders )A person who founded this organization (legacy spelling; see singular form, founder).
 *
 *
 * -------------------------------- FoundingDate ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setFoundingDate(\Bordeux\SchemaOrg\SchemaDateTime $foundingDate )The date that this organization was founded.
 *
 *
 * -------------------------------- HasPOS ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setHasPOS(\Bordeux\SchemaOrg\Thing\Place $hasPOS )Points-of-Sales operated by the organization or person.
 *
 *
 * -------------------------------- LegalName ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setLegalName(string $legalName )The official name of the organization, e.g. the registered company name.
 *
 *
 * -------------------------------- Location ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setLocation(\Bordeux\SchemaOrg\Thing\Intangible\StructuredValue\ContactPoint\PostalAddress $location ) setLocation(\Bordeux\SchemaOrg\Thing\Place $location )The location of the event, organization or action.
 *
 *
 * -------------------------------- MakesOffer ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setMakesOffer(\Bordeux\SchemaOrg\Thing\Intangible\Offer $makesOffer )A pointer to products or services offered by the organization or person.
 *
 *
 * -------------------------------- Member ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setMember(\Bordeux\SchemaOrg\Thing\Organization $member ) setMember(\Bordeux\SchemaOrg\Thing\Person $member )A member of this organization.
 *
 *
 * -------------------------------- Members ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setMembers(\Bordeux\SchemaOrg\Thing\Organization $members ) setMembers(\Bordeux\SchemaOrg\Thing\Person $members )A member of this organization (legacy spelling; see singular form, member).
 *
 *
 * -------------------------------- Naics ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setNaics(string $naics )The North American Industry Classification System (NAICS) code for a particular organization or business person.
 *
 *
 * -------------------------------- Owns ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setOwns(\Bordeux\SchemaOrg\Thing\Intangible\StructuredValue\OwnershipInfo $owns ) setOwns(\Bordeux\SchemaOrg\Thing\Product $owns )Products owned by the organization or person.
 *
 *
 * -------------------------------- Seeks ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setSeeks(\Bordeux\SchemaOrg\Thing\Intangible\Demand $seeks )A pointer to products or services sought by the organization or person (demand).
 *
 *
 * -------------------------------- SubOrganization ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setSubOrganization(\Bordeux\SchemaOrg\Thing\Organization $subOrganization )A relationship between two organizations where the first includes the second, e.g., as a subsidiary. See also: the more specific 'department' property.
 *
 *
 * -------------------------------- TaxID ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setTaxID(string $taxID )The Tax / Fiscal ID of the organization or person, e.g. the TIN in the US or the CIF/NIF in Spain.
 *
 *
 * -------------------------------- VatID ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setVatID(string $vatID )The Value-added Tax ID of the organisation or person.
 *
 *
 * -------------------------------- BranchOf ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setBranchOf(\Bordeux\SchemaOrg\Thing\Organization $branchOf )The larger organization that this local business is a branch of, if any.
 *
 *
 * -------------------------------- CurrenciesAccepted ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setCurrenciesAccepted(string $currenciesAccepted )The currency accepted (in ISO 4217 currency format).
 *
 *
 * -------------------------------- PaymentAccepted ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setPaymentAccepted(string $paymentAccepted )Cash, credit card, etc.
 *
 *
 * -------------------------------- PriceRange ---------------------------------------------
 *
 ...
 *
 * @method StadiumOrArena setPriceRange(string $priceRange )The price range of the business, for example $$$.
 *
 *
 */
